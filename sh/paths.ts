...
export const pathExampleAuthReactOutput = resolve(pathExample, 'dist/auth-react')
export const pathExampleWalletReactOutput = resolve(pathExample, 'dist/wallet-react')
