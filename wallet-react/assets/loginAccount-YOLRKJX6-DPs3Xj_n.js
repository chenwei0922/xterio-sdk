import{N as _}from"./chunk-XOADOAIQ-BDZrSLL7.js";import{w}from"./chunk-52P64AJK-kLY1TL_6.js";import{p as k}from"./chunk-3ESANLHR-DDJ8eKGE.js";import{N as E}from"./chunk-2EPM6PV4-DGrOr6g7.js";import{aQ as N,r as h,aR as T,aS as $,aT as O,A as s,Y as S,V as A,v as j,t as z,w as B,p as F,X as C,F as I,o as c}from"./index-DJbFNRqX.js";import{B as L}from"./throttle-m3FcaDod.js";import{u as M}from"./useTranslation-mZbsLClP.js";function P(l,e){var t,r=N(l),u=(t=e==null?void 0:e.wait)!==null&&t!==void 0?t:1e3,o=h.useMemo(function(){return L(function(){for(var i=[],a=0;a<arguments.length;a++)i[a]=arguments[a];return r.current.apply(r,T([],$(i),!1))},u,e)},[]);return O(function(){o.cancel()}),{run:o,cancel:o.cancel,flush:o.flush}}var R=`.login-account-box {
  display: flex;
